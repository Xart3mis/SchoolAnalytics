...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-[color:var(--border)] bg-[color:var(--surface)] shadow-[0_14px_34px_-26px_rgba(28,36,48,0.32)] dark:shadow-[0_18px_44px_-32px_rgba(0,0,0,0.6)] sm:rounded-2xl",
      className
    )}
    {...props}
  />
